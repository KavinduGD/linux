...
## 51. what happen when a directory has no read permission (r)? `-wx`
...
## 52. What happens when a directory has no execute permission (x)? `rw-`
...
## 53. What happens when a directory has no write permission (w)? `r-x`
